                        ...
                        <div class="sidebar-category sidebar-category-visible">
                            <div class="category-content no-padding">
                                <ul class="navigation navigation-main navigation-accordion">
                                    ...
                                    <li class="{{ (request()->is('provider/university*')) ? 'active' : '' }}"><a href="{{route('provider.university.index')}}"><i class="icon-office"></i> <span>University</span></a></li>
                                    <li class="{{ (request()->is('provider/post*')) ? 'active' : '' }}"><a href="{{route('provider.post.index')}}"><i class="icon-office"></i> <span>Post</span></a></li>
                                    <li class="{{ (request()->is('provider/teacherRatingList')) ? 'active' : '' }}"><a href="{{route('provider.teacherRatingList')}}"><i class="icon-office"></i> <span>Teacher Rating</span></a></li>
