...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Post Create</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.post.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea name="details" id="details" class="form-control" placeholder="Post Details"></textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
