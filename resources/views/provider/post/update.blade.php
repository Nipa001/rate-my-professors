...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Post Update</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.post.update', [$post_info->id])}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                   ...
                   <div class="form-group">
                    <label class="control-label col-lg-3" for="title">Post Title <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" name="title" id="title" class="form-control" placeholder="Post Title" value="{{$post_info->title}}" required>
                    </div>
                </div>
                <!-- Image input -->
                <div class="form-group">
                    <label class="col-lg-3 control-label text-semibold">Post Image</label>
                    <div class="col-lg-6">
                        <div class="file-preview" id="custom_file_preview">
                            ...
                            <div class="file-preview-thumbnails">
                                <div class="file-preview-frame" id="preview-1603644588432-0">
                                    <img src="{{ asset('uploads/post/'.$post_info->image)}}" class="file-preview-image" title="{{$post_info->image}}" alt="{{$post_info->image}}" style="width:auto;height:160px;">
                                </div>
                            </div>
                            <div class="clearfix"></div>   
                            <div class="file-preview-status text-center text-success"></div>
                            <div class="kv-fileinput-error file-error-message" style="display: none;"></div>
                            <input type="hidden" name="image" value="{{$post_info->image}}">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <textarea name="details" id="details" class="form-control" placeholder="Post Details">{{$post_info->details}}</textarea>
                    </div>
                </div>
                <!-- /basic textarea -->
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('provider.post.index')}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
