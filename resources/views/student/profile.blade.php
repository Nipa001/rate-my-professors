                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @if( $student_info->image != Null || !empty($student_info->image)) 
                                                    ...
                                                    <div class="file-preview" id="custom_file_preview">
                                                        ...
                                                        <div class="file-preview-thumbnails">
                                                            <div class="file-preview-frame" id="preview-1603644588432-0">
                                                                <img src="{{ asset('uploads/studentProfile/'.$student_info->image)}}" class="file-preview-image" alt="{{$student_info->image}}" style="width:auto;height:200px;">
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>   
                                                        <div class="file-preview-status text-center text-success"></div>
                                                        <div class="kv-fileinput-error file-error-message" style="display: none;"></div>
                                                        <input type="hidden" name="student_image" value="{{$student_info->image}}">
                                                    </div>
                                                    <div id="custom_file_input" style="display: none;">
                                                        <input type="file" name="student_image" class="file-input-extensions">
        ...
        <div class="col-lg-3">
            ...
            <div class="thumbnail">
                ...
                <div class="caption text-center">
                    <h6 class="text-semibold no-margin">{{$student_info->name}}</h6>
